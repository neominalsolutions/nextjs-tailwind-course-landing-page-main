...
function LoginPage() {
	return (
		<>
			<div className="flex mx-auto  overflow-hidden bg-white max-w-4xl mt-10 box-shadow border ">
				<div
					className="hidden bg-cover lg:block lg:w-1/2"
					style={{
						backgroundImage:
							"url('https://images.unsplash.com/photo-1606660265514-358ebbadc80d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=htmlFormat&fit=crop&w=1575&q=80');",
					}}
				></div>
