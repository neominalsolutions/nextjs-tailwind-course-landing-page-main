	...
	return (
		<div>
			<section className="px-8 mt-2">
				...
				<div className="min-h-screen bg-gradient-to-tr from-purple-300 to-blue-200 flex justify-center items-center py-20">
					<div className="md:px-4 md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0">
						<div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500 cursor-pointer">
